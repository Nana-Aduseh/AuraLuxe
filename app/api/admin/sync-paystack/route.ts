    ...
    for (const tx of missingTransactions) {
      ...
      const { data: createdOrder, error: createError } = await supabase
        ...
        .insert({
          ...
          guest_first_name: guestInfo.firstName || payData?.customer?.first_name || null,
          guest_last_name: guestInfo.lastName || payData?.customer?.last_name || null,
          guest_email: guestInfo.email || payData?.customer?.email || null,
          guest_phone: guestInfo.phone || payData?.customer?.phone || null,
