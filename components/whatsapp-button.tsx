...
export default function WhatsAppButton({
  message = "Hi AuraLuxe Hair, I want to make an enquiry.",
}: WhatsAppButtonProps) {
  ...
  return (
    <a
      ...
      aria-label="Chat with AuraLuxe Hair on WhatsApp"
    ...
    >
      <svg viewBox="0 0 32 32" className="h-5 w-5 fill-current" aria-hidden="true">
        ...
        <path d="M16 3C8.83 3 3 8.83 3 16c0 2.54.73 4.91 1.99 6.92L3 29l6.26-1.95A12.93 12.93 0 0 1 16 29c7.17 0 13-5.83 13-13S23.17 3 16 3zm0 23.64c-2.07 0-4.09-.55-5.86-1.58l-.42-.25-3.72 1.16 1.2-3.62-.27-.45A10.6 10.6 0 0 1 5.36 16C5.36 10.13 10.13 5.36 16 5.36S26.64 10.13 26.64 16 21.87 26.64 16 26.64z" />
      </svg>
